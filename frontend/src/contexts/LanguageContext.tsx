...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    reviewerAssignments: 'My Assignments',
    ...
    authInstitutionPlaceholder: 'Your institution',
    ...
    adminAssignments: 'All Assignments',
  ...
  zh: {
    ...
    myAccount: '我的账户',
    newSubmission: '新建投稿',
    reviewerAssignments: '我的审稿',
    adminPanel: '管理后台',
    mySubmissions: '我的投稿',
    profile: '个人信息',
    changePassword: '修改密码',
    createSubmission: '创建投稿',
    submitForReview: '提交审阅',
    withdraw: '撤回',
    uploadPDF: '上传PDF',
    authPasswordMinLength: '密码至少需要8个字符',
    authInstitution: '所属机构',
    authInstitutionPlaceholder: '您的机构',
    regSuccessMsg: '注册成功！您现在可以登录了。',
    paperInformation: '论文信息',
    ...
    overallScore: '总分',
    recommendation: '建议',
    detailedComments: '详细意见',
    yourReview: '您的审稿',
    rebuttal: '复议',
    submitRebuttal: '提交复议',
    accept: '接受',
    decline: '拒绝',
    assignmentAccepted: '已受理',
    ...
    decision: '决策',
    adminUsers: '用户管理',
    adminSubmissions: '投稿管理',
    adminPeriods: '投稿期管理',
    adminReviewsPage: '审稿管理',
    adminAssignments: '审稿分配',
    availableReviewers: '候选审稿人',
    manualAssignment: '手动分配',
    autoAssign: '自动分配',
    allAssignments: '全部审稿分配',
  },
};
