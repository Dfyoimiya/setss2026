...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    setss2026Submission: 'SETSS 2026 Submission',
    paperSubmissionInstructions: 'Submission Instructions',
    ...
    registrationBadge: '8th Spring School',
    registrationHeroTitle: 'Spring School on Engineering Trustworthy Software Systems',
    registrationHeroDesc: 'Welcome to the 8th Spring School on Engineering Trustworthy Software Systems. Please review the registration details carefully and complete the enrollment process.',
    registrationHeroLocation: 'Southwest University · Chongqing',
    registrationDuration: '7 days duration',
    ...
    registrationFeeDescFull: 'Full access to all lectures & activities',
    registrationFeeDescWorkshop: 'Workshop participation only',
    bankTransferTitle: 'Bank Transfer Details',
    bankTransferHint: 'Please complete payment via bank transfer',
  ...
  zh: {
    ...
    gettingThere: '交通指南',
    accommodation: '住宿',
    setss2026Submission: 'SETSS 2026 投稿',
    paperSubmissionInstructions: '投稿指南',
    submitPaper: '提交论文',
    dashboard: '仪表盘',
    adminPanel: '后台管理',
    login: '登录',
    ...
    // === Registration Page ===
    registrationTitle: '注册费用',
    registrationBadge: '第八届春季学校',
    registrationHeroTitle: '可信软件系统工程春季学校',
    registrationHeroDesc: '欢迎参加第八届可信软件系统工程春季学校，请仔细阅读以下注册信息，完成报名流程。',
    registrationHeroLocation: '西南大学 · 重庆',
    registrationDuration: '为期7天',
    ...
    registrationFeeDescFull: '全程参与所有课程与活动',
    registrationFeeDescWorkshop: '专题工作坊参与',
    bankTransferTitle: '银行转账信息',
    bankTransferHint: '请通过银行转账完成费用支付',
