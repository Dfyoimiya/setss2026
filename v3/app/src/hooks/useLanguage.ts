...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    setss2026Submission: 'SETSS2026 Submission',
    paperSubmissionInstructions: 'Paper Submission Instructions',
    programSchedule: 'Program Schedule',
    programAtAGlance: 'Program at a Glance',
  ...
  zh: {
    ...
    workshop: '研讨会',
    importantDates: '重要日期',
    setss2026Submission: 'SETSS2026投稿',
    paperSubmissionInstructions: '投稿须知',
    programSchedule: '日程安排',
    programAtAGlance: '日程概览',
    ...
    heroVenue: '中国重庆西南大学',
    heroImageAlt: '西南大学',conferenceChair: '会议主席',
    backToHome: '返回首页',
  ...
  eventOpeningDetail: '西南大学校长、计算机与信息科学学院院长致辞，刘志明教授作SETSS会议简述。集体合影。',
