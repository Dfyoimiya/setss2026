      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-start">
          <div>
            ...
            <p className="animate-in text-[14px] text-slate-600 leading-relaxed mt-8">{t('welcomeDesc3')}</p>
          </div>

          <div>
            <div className="animate-in relative overflow-hidden">
              <img src="/images/25.jpg" alt={t('swuCampusAlt')} className="w-full aspect-[4/3] object-cover" />
            </div>
